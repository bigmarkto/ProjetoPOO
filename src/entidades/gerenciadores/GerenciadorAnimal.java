...
public class GerenciadorAnimal implements Interface {
    ...
    /**
     * Procura um animal pelo seu nome e dono e retorna ele.
     *
    ...
    /**
     * Procura um animal pelo seu nome e exibe suas informações em formato
     * tabular se encontrado.
     *
     * @param nome O nome do animal a ser procurado.
     */
    ...
    /**
     * Procura um animal pelo seu dono e exibe suas informações em formato
     * tabular se encontrado.
     *
     * @param dono O nome do dono do animal a ser procurado.
     */
    ...
    /**
     * Procura um animal pela sua idade e exibe suas informa es em formato
     * tabular se encontrado.
     *
     ...
     *
     * Mostra um menu para escolher o tipo do animal e suas informações. Após
     * preencher as informações, o usuário é perguntado se deseja cadastrar
     * outro animal.
     */
    @Override
     ...
     * alterar (nome, idade ou dono). Após a alteração, o usuário é perguntado
     * se deseja alterar outro animal.
     */
    @Override
    public void alterar() {
        String dono, nome;
     ...
     *
     * Exibe um menu para selecionar o ID do animal a ser removido. Após a
     ...
     * cadastrado." Caso contrário, exibe a tabela com as colunas ID, Nome,
     * Idade, Dono e Tipo.
     */
    @Override
     ...
     * corresponder a um dos seguintes valores: 1 (Cachorro), 2 (Gato), 3
     * (Peixe), 4 (Pássaro), ou 5 (Coelho). Se um tipo inválido for fornecido,
     * uma mensagem de erro será exibida.
     *
     * Se não houver animais do tipo especificado, uma mensagem indicando que
     * nenhum animal foi encontrado será exibida.
     *
     * @param tipo O código numérico representando o tipo de animal a ser
     * listado.
     */
    @Override
     ...
     *
     * Exibe um menu para o usuário selecionar o critério de busca: nome, idade
     * ou dono. Após selecionar o critério, solicita ao usuário o valor
     * correspondente para busca e exibe os animais encontrados utilizando
    ...
    /**
     * Exibe o menu de gerenciamento de clientes ao usuário.
     *
     * O menu oferece as opções de cadastrar um cliente, alterar um cliente,
     * listar todos os clientes, listar clientes por tipo, buscar um cliente,
     * remover um cliente e voltar.
     *
